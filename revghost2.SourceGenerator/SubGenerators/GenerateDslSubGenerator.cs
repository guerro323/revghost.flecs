...
using revghost2.SourceGenerator;

namespace ManiaGen.SourceGenerator.SubGenerators;
...
public class GenerateDslSubGenerator : SubGenerator
{
    ...
    {
        sb.Append('(');
        sb.Append("revghost2.StaticEntity<");
    ...
    public void GenerateDsl(IList<Term> terms, Export export, ISymbol symbol, SemanticModel model)
    {
        ...
        {
            codeBuilder.AppendLine("public global::revghost2.World RealWorld { get; }");
            codeBuilder.AppendLine("public global::revghost2.World World { get; }");
            codeBuilder.AppendLine("public float SystemDeltaTime { get; }");
        }
        
        codeBuilder.AppendLine("public global::revghost2.Entity Entity { get; }");
        codeBuilder.AppendLine("public global::revghost2.EntityId Id { get; }");
        ...
        if (export.Kind is EKind.System or EKind.Processor or EKind.Observer) {
            ...
            // Setup
            {
                codeBuilder.AppendLine("public static unsafe void Setup(revghost2.World world)");
                codeBuilder.BeginBracket();
                {
